...
game.showLongText("Press B to start! Or just look at the screen. Your choice.", DialogLayout.Bottom)
...
forever(function () {
    ...
    music.play(music.stringPlayable("E B C5 A B G A F ", 70), music.PlaybackMode.UntilDone)
})
forever(function () {
    if (gameStart == 1) {
        scoreAdd = 1
